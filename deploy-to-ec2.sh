INSTANCE_ID="i-091d1dcb0c1358f59" # Replace your EC2 Instance ID

APP_CONTAINER_NAME="nextjs-app" # Container name inside EC2 instance

# this should match to whatever your registry URL is for the docker image
